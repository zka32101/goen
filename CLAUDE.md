...
**Last Updated**: 2026-09-20 (finished the runtime-failure repair pass — see "2026-09-20 | Finished the runtime-failure repair pass" near the end of the Timeline. `flutter test` now reports 821/823 passing; the only 2 remaining failures are the pre-existing, not-fixable-from-this-sandbox placeholder Firebase credentials in `firebase_options.dart`)
